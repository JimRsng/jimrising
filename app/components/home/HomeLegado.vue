<template>
  <UPageHero
    ...
    as="section"
  >
    <div aria-hidden="true" role="presentation" class="absolute left-[50%] translate-x-[-50%] -bottom-16 text-[16rem] text-nowrap pointer-events-none select-none text-red-500 opacity-3 font-bold font-bebas tracking-widest">STARCRAFT</div>
    <template #title>
      <div>
    ...
    <template #description>
      <div class="flex flex-col gap-8">
        ...
        <div class="grid grid-cols-3 border border-primary/30 divide-x divide-primary/30 text-center">
